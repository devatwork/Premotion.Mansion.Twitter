...
rem Publish
%nuget% push Premotion.Mansion.Twitter.0.1.0.nupkg -Source "https://www.myget.org/F/premotion/api/v2/package"
%nuget% push Premotion.Mansion.Twitter.0.1.0.symbols.nupkg -Source "https://nuget.symbolsource.org/MyGet/premotion"